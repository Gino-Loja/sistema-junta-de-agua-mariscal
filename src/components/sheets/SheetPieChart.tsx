...
export default function SheetsPieChart({ sectors = [] }: { sectors?: { sector_nombre: string, total_recaudado: number }[] }) {
    ...
    return (
        <div className="w-full ">
                    ...
                    <PieChart>
                        <Pie
                            ...
                            label={({ sector_nombre, total_recaudado, cx, cy, midAngle, innerRadius, outerRadius }) => {
                                const radius = outerRadius + 20; // Increased radius for better spacing
                                ...
                                return (
                                    <text
                                        ...
                                        className="text-sm font-medium fill-gray-900" // Updated text color
                                    >
                                        {total_recaudado.toLocaleString()} m³
                                    </text>
                                );
                            }}
                            labelLine={({ cx, cy, midAngle, outerRadius }) => {
                                ...
                                const endRadius = outerRadius + 15; // Increased line length
                                ...
                                return (
                                    <line
                                        ...
                                        x2={endX}
                                        y2={endY}
                                        stroke="#666" // Updated line color
                                        strokeWidth={1.5} // Increased line width
                                    />
                                );
                            }}
                        >
            ...
            <CustomLegend sectors={sectors} theme={theme} />
        </div>
    );
}
