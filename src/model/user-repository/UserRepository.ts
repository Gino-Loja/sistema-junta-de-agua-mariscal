...
export interface IUserRepository {
    ...
    getAllPagination: ( query: string, sector:string, estado:string) => Promise<QueryResultError<TotalUser[]>>;
    ...
    getUserPagination: (currentPage: number, itemsPerPage: number, query: string, sector:string, estado:string) => Promise<QueryResultError<User[]>>;
}
