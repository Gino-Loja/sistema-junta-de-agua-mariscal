import { QueryResultError, WaterMeter, WaterMeterCreate, WaterMeterDto } from "../types";
...
export interface IWaterMeter {
    ...
    createWaterMeter: (waterMeter: WaterMeterCreate) => Promise<QueryResultError<boolean>>
